...
export default function QRCreate() {
  ...
  const handleXPChange = (e) => (e.target.value <= COIN_CAP) ? setCoins(e.target.value) : setCoins(COIN_CAP)
  const handlePointsChange = (e) => (e.target.value <= POINTS_CAP) ? setPoints(e.target.value) : setPoints(POINTS_CAP) 
